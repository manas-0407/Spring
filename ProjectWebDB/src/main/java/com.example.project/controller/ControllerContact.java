...
public class ControllerContact {
    ...
    public ModelAndView displayMessage_controller(Contact contact) {
    ...
    public String close_message(@RequestParam int id, Authentication authentication){

        contactService.close_status(id,authentication.getName());
